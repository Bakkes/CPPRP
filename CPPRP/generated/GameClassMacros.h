...
GAMEFIELD(TAGame, PRI_TA, PossessionSteals, int);
GAMEFIELD(TAGame, PRI_TA, PossessionDenials, int);
GAMEFIELD(TAGame, PRI_TA, PossessionClears, int);
GAMEFIELD(TAGame, PRI_TA, BallDemolitionSaves, int);
GAMEFIELD(TAGame, PRI_TA, CarDemolitions, int);
GAMEFIELD(TAGame, PRI_TA, BallDemolitions, int);
GAMEFIELD(TAGame, PRI_TA, SelfDemolitions, int);
...
GAMEFIELD(TAGame, GameEvent_TA, bAlwaysShowMatchTypeLabel, bool);
...
GAMECLASS(TAGame, ViralItemActor_TA);
GAMEFIELD(TAGame, ViralItemActor_TA, InfectedStatus, unsigned char);
GAMEFIELD(TAGame, ViralItemActor_TA, ClientFXInfectedType, unsigned char);
