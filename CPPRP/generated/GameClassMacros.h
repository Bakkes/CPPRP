...
GAMECLASS(Engine, ADynamicSMActor);
GAMEFIELD(Engine, ADynamicSMActor, ReplicatedMesh, ObjectTarget);
GAMEFIELD(Engine, ADynamicSMActor, ReplicatedMaterial0, ObjectTarget);
GAMEFIELD(Engine, ADynamicSMActor, ReplicatedMaterial1, ObjectTarget);
GAMEFIELD(Engine, ADynamicSMActor, ReplicatedMaterial2, ObjectTarget);
GAMEFIELD(Engine, ADynamicSMActor, ReplicatedMaterial3, ObjectTarget);
GAMEFIELD(Engine, ADynamicSMActor, bForceStaticDecals, bool);
GAMEFIELD(Engine, ADynamicSMActor, ReplicatedMeshTranslation, Vector3);
GAMEFIELD(Engine, ADynamicSMActor, ReplicatedMeshRotation, Rotator);
GAMEFIELD(Engine, ADynamicSMActor, ReplicatedMeshScale3D, Vector3);
...
GAMEFIELD(ProjectX, Pawn_X, bIsWalking, bool);
GAMEFIELD(ProjectX, Pawn_X, bIsCrouched, bool);
GAMEFIELD(ProjectX, Pawn_X, bSimulateGravity, bool);
GAMEFIELD(ProjectX, Pawn_X, bCanSwatTurn, bool);
GAMEFIELD(ProjectX, Pawn_X, bUsedByMatinee, bool);
GAMEFIELD(ProjectX, Pawn_X, bRootMotionFromInterpCurve, bool);
...
GAMEFIELD(ProjectX, Pawn_X, PlayerReplicationInfo, ActiveActor);
GAMEFIELD(ProjectX, Pawn_X, RootMotionInterpRate, float);
GAMEFIELD(ProjectX, Pawn_X, RootMotionInterpCurrentTime, float);
GAMEFIELD(ProjectX, Pawn_X, RootMotionInterpCurveLastValue, Vector3I);
