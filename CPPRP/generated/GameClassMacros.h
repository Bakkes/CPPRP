...
GAMEFIELD(Engine, PlayerReplicationInfo, Ping, unsigned char);
...
GAMEFIELD(TAGame, PRI_TA, CameraYaw, unsigned char);
GAMEFIELD(TAGame, PRI_TA, CameraPitch, unsigned char);
GAMEFIELD(TAGame, PRI_TA, PawnType, unsigned char);
GAMEFIELD(TAGame, PRI_TA, ReplicatedWorstNetQualityBeyondLatency, unsigned char);
...
GAMEFIELD(TAGame, CarComponent_TA, ReplicatedActive, unsigned char);
...
GAMEFIELD(TAGame, CarComponent_Boost_TA, ReplicatedBoostAmount, unsigned char);
...
GAMEFIELD(TAGame, CameraSettingsActor_TA, CameraPitch, unsigned char);
...
GAMEFIELD(TAGame, CameraSettingsActor_TA, CameraYaw, unsigned char);
