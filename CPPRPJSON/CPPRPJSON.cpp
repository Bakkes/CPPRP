...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::Engine::Actor>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::Engine::Info>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::Engine::ReplicationInfo>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::Engine::GameReplicationInfo>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::Engine::Pawn>(struc);
        Serialize<CPPRP::Engine::Actor>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::Engine::PlayerReplicationInfo>(struc);
        Serialize<CPPRP::Engine::ReplicationInfo>(writer, item);
        writer.String("Team");
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::Engine::TeamInfo>(struc);
        Serialize<CPPRP::Engine::ReplicationInfo>(writer, item);
        writer.String("Score");
        Serialize<uint32_t>(writer, item.Score);
}
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::Engine::WorldInfo>(struc);
        Serialize<CPPRP::Engine::Info>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::ProjectX::GRI_X>(struc);
        Serialize<CPPRP::ProjectX::Engine::GameReplicationInfo>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::ProjectX::Pawn_X>(struc);
        Serialize<CPPRP::ProjectX::Engine::Pawn>(writer, item);
}

template<typename Writer>
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::ProjectX::PRI_X>(struc);
        Serialize<CPPRP::ProjectX::Engine::PlayerReplicationInfo>(writer, item);
}

template<typename Writer>
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc);
        Serialize<CPPRP::TAGame::ProjectX::PRI_X>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::RBActor_TA>(struc);
        Serialize<CPPRP::TAGame::ProjectX::Pawn_X>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::CarComponent_TA>(struc);
        Serialize<CPPRP::TAGame::Engine::ReplicationInfo>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::CarComponent_Jump_TA>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::CarComponent_DoubleJump_TA>(struc);
        Serialize<CPPRP::TAGame::CarComponent_TA>(writer, item);
}
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::CarComponent_Boost_TA>(struc);
        Serialize<CPPRP::TAGame::CarComponent_TA>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::CarComponent_Dodge_TA>(struc);
        Serialize<CPPRP::TAGame::CarComponent_TA>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::CarComponent_FlipCar_TA>(struc);
        Serialize<CPPRP::TAGame::CarComponent_TA>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::Ball_TA>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::Team_TA>(struc);
        Serialize<CPPRP::TAGame::Engine::TeamInfo>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::Team_Soccar_TA>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::BreakOutActor_Platform_TA>(struc);
        Serialize<CPPRP::TAGame::Engine::Actor>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_TA>(struc);
        Serialize<CPPRP::TAGame::CarComponent_TA>(writer, item);
}
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_Targeted_TA>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_Tornado_TA>(struc);
        Serialize<CPPRP::TAGame::SpecialPickup_TA>(writer, item);
}
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_HauntedBallBeam_TA>(struc);
        Serialize<CPPRP::TAGame::SpecialPickup_TA>(writer, item);
}
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_BallVelcro_TA>(struc);
        Serialize<CPPRP::TAGame::SpecialPickup_TA>(writer, item);
        writer.String("bHit");
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_Rugby_TA>(struc);
        Serialize<CPPRP::TAGame::SpecialPickup_TA>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_BallFreeze_TA>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_Spring_TA>(struc);
        Serialize<CPPRP::TAGame::SpecialPickup_Targeted_TA>(writer, item);
}
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_BallCarSpring_TA>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_BallGravity_TA>(struc);
        Serialize<CPPRP::TAGame::SpecialPickup_TA>(writer, item);
}
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_GrapplingHook_TA>(struc);
        Serialize<CPPRP::TAGame::SpecialPickup_Targeted_TA>(writer, item);
}
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_BallLasso_TA>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_BoostOverride_TA>(struc);
        Serialize<CPPRP::TAGame::SpecialPickup_Targeted_TA>(writer, item);
}
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_Batarang_TA>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_HitForce_TA>(struc);
        Serialize<CPPRP::TAGame::SpecialPickup_TA>(writer, item);
}
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_Swapper_TA>(struc);
        Serialize<CPPRP::TAGame::SpecialPickup_Targeted_TA>(writer, item);
}
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::CrowdManager_TA>(struc);
        Serialize<CPPRP::TAGame::Engine::ReplicationInfo>(writer, item);
        writer.String("GameEvent");
        Serialize<CPPRP::ActiveActor>(writer, item.GameEvent);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::CrowdActor_TA>(struc);
        Serialize<CPPRP::TAGame::Engine::ReplicationInfo>(writer, item);
        writer.String("GameEvent");
        Serialize<CPPRP::ActiveActor>(writer, item.GameEvent);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::InMapScoreboard_TA>(struc);
        Serialize<CPPRP::TAGame::Engine::Actor>(writer, item);
}
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::Vehicle_TA>(struc);
        Serialize<CPPRP::TAGame::RBActor_TA>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::Car_TA>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::Car_Season_TA>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::CameraSettingsActor_TA>(struc);
        Serialize<CPPRP::TAGame::Engine::ReplicationInfo>(writer, item);
        writer.String("PRI");
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::GRI_TA>(struc);
        Serialize<CPPRP::TAGame::ProjectX::GRI_X>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::Ball_Breakout_TA>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::VehiclePickup_TA>(struc);
        Serialize<CPPRP::TAGame::Engine::ReplicationInfo>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::VehiclePickup_Boost_TA>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::Ball_Haunted_TA>(struc);
        Serialize<CPPRP::TAGame::Ball_TA>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::GameEvent_TA>(struc);
        Serialize<CPPRP::TAGame::Engine::ReplicationInfo>(writer, item);
        writer.String("ReplicatedRoundCountDownNumber");
        Serialize<uint32_t>(writer, item.ReplicatedRoundCountDownNumber);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::GameEvent_Team_TA>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::GameEvent_Breakout_TA>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::GameEvent_Season_TA>(struc);
        Serialize<CPPRP::TAGame::GameEvent_Soccar_TA>(writer, item);
}
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::GameEvent_SoccarPrivate_TA>(struc);
        Serialize<CPPRP::TAGame::GameEvent_Soccar_TA>(writer, item);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::GameEvent_SoccarSplitscreen_TA>(struc);
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::GameEvent_Tutorial_TA>(struc);
        Serialize<CPPRP::TAGame::GameEvent_Soccar_TA>(writer, item);
}
...
inline const void Serialize(Writer& writer, const std::shared_ptr<CPPRP::Engine::Actor>& struc)
{
        auto item = std::static_pointer_cast<CPPRP::TAGame::HauntedBallTrapTrigger_TA>(struc);
        Serialize<CPPRP::TAGame::Engine::Actor>(writer, item);
}

template<typename T>
constexpr void RegisterJSONSerializer(const std::string& variable, T func)
{

}

constexpr void InitializeSingles()
{
RegisterJSONSerializer("Engine.Actor:DrawScale", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("DrawScale");
                Serialize<float>(std::static_pointer_cast<CPPRP::Engine::Actor>(struc)->DrawScale);
        });
RegisterJSONSerializer("Engine.Actor:bCollideActors", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bCollideActors");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::Actor>(struc)->bCollideActors);
        });
RegisterJSONSerializer("Engine.Actor:bCollideWorld", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bCollideWorld");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::Actor>(struc)->bCollideWorld);
        });
RegisterJSONSerializer("Engine.Actor:bNetOwner", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bNetOwner");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::Actor>(struc)->bNetOwner);
        });
RegisterJSONSerializer("Engine.Actor:Base", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("Base");
                Serialize<CPPRP::ActorBase>(std::static_pointer_cast<CPPRP::Engine::Actor>(struc)->Base);
        });
RegisterJSONSerializer("Engine.Actor:bBlockActors", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bBlockActors");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::Actor>(struc)->bBlockActors);
        });
RegisterJSONSerializer("Engine.Actor:bHidden", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bHidden");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::Actor>(struc)->bHidden);
        });
RegisterJSONSerializer("Engine.Actor:bTearOff", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bTearOff");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::Actor>(struc)->bTearOff);
        });
RegisterJSONSerializer("Engine.Actor:Location", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("Location");
                Serialize<CPPRP::Vector3I>(std::static_pointer_cast<CPPRP::Engine::Actor>(struc)->Location);
        });
RegisterJSONSerializer("Engine.Actor:Rotation", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("Rotation");
                Serialize<CPPRP::Rotator>(std::static_pointer_cast<CPPRP::Engine::Actor>(struc)->Rotation);
        });
RegisterJSONSerializer("Engine.GameReplicationInfo:ServerName", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ServerName");
                Serialize<std::string>(std::static_pointer_cast<CPPRP::Engine::GameReplicationInfo>(struc)->ServerName);
        });
RegisterJSONSerializer("Engine.GameReplicationInfo:GameClass", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("GameClass");
                Serialize<CPPRP::ObjectTarget>(std::static_pointer_cast<CPPRP::Engine::GameReplicationInfo>(struc)->GameClass);
        });
RegisterJSONSerializer("Engine.GameReplicationInfo:bStopCountDown", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bStopCountDown");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::GameReplicationInfo>(struc)->bStopCountDown);
        });
RegisterJSONSerializer("Engine.GameReplicationInfo:bMatchIsOver", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bMatchIsOver");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::GameReplicationInfo>(struc)->bMatchIsOver);
        });
RegisterJSONSerializer("Engine.GameReplicationInfo:bMatchHasBegun", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bMatchHasBegun");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::GameReplicationInfo>(struc)->bMatchHasBegun);
        });
RegisterJSONSerializer("Engine.Pawn:PlayerReplicationInfo", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("PlayerReplicationInfo");
                Serialize<CPPRP::ActiveActor>(std::static_pointer_cast<CPPRP::Engine::Pawn>(struc)->PlayerReplicationInfo);
        });
RegisterJSONSerializer("Engine.Pawn:HealthMax", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("HealthMax");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::Engine::Pawn>(struc)->HealthMax);
        });
RegisterJSONSerializer("Engine.Pawn:bIsCrouched", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bIsCrouched");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::Pawn>(struc)->bIsCrouched);
        });
RegisterJSONSerializer("Engine.PlayerReplicationInfo:Team", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("Team");
                Serialize<CPPRP::ActiveActor>(std::static_pointer_cast<CPPRP::Engine::PlayerReplicationInfo>(struc)->Team);
        });
RegisterJSONSerializer("Engine.PlayerReplicationInfo:bReadyToPlay", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bReadyToPlay");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::PlayerReplicationInfo>(struc)->bReadyToPlay);
        });
RegisterJSONSerializer("Engine.PlayerReplicationInfo:PlayerName", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("PlayerName");
                Serialize<std::string>(std::static_pointer_cast<CPPRP::Engine::PlayerReplicationInfo>(struc)->PlayerName);
        });
RegisterJSONSerializer("Engine.PlayerReplicationInfo:RemoteUserData", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("RemoteUserData");
                Serialize<std::string>(std::static_pointer_cast<CPPRP::Engine::PlayerReplicationInfo>(struc)->RemoteUserData);
        });
RegisterJSONSerializer("Engine.PlayerReplicationInfo:bWaitingPlayer", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bWaitingPlayer");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::PlayerReplicationInfo>(struc)->bWaitingPlayer);
        });
RegisterJSONSerializer("Engine.PlayerReplicationInfo:Score", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("Score");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::Engine::PlayerReplicationInfo>(struc)->Score);
        });
RegisterJSONSerializer("Engine.PlayerReplicationInfo:PlayerID", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("PlayerID");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::Engine::PlayerReplicationInfo>(struc)->PlayerID);
        });
RegisterJSONSerializer("Engine.PlayerReplicationInfo:bBot", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bBot");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::PlayerReplicationInfo>(struc)->bBot);
        });
RegisterJSONSerializer("Engine.PlayerReplicationInfo:bIsSpectator", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bIsSpectator");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::PlayerReplicationInfo>(struc)->bIsSpectator);
        });
RegisterJSONSerializer("Engine.PlayerReplicationInfo:bTimedOut", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bTimedOut");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::PlayerReplicationInfo>(struc)->bTimedOut);
        });
RegisterJSONSerializer("Engine.PlayerReplicationInfo:bAdmin", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bAdmin");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::PlayerReplicationInfo>(struc)->bAdmin);
        });
RegisterJSONSerializer("Engine.PlayerReplicationInfo:bIsInactive", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bIsInactive");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::PlayerReplicationInfo>(struc)->bIsInactive);
        });
RegisterJSONSerializer("Engine.PlayerReplicationInfo:bOnlySpectator", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bOnlySpectator");
                Serialize<bool>(std::static_pointer_cast<CPPRP::Engine::PlayerReplicationInfo>(struc)->bOnlySpectator);
        });
RegisterJSONSerializer("Engine.PlayerReplicationInfo:Ping", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("Ping");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::Engine::PlayerReplicationInfo>(struc)->Ping);
        });
RegisterJSONSerializer("Engine.PlayerReplicationInfo:UniqueId", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("UniqueId");
                Serialize<class std::shared_ptr<CPPRP::UniqueId>>(std::static_pointer_cast<CPPRP::Engine::PlayerReplicationInfo>(struc)->UniqueId);
        });
RegisterJSONSerializer("Engine.TeamInfo:Score", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("Score");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::Engine::TeamInfo>(struc)->Score);
        });
RegisterJSONSerializer("Engine.WorldInfo:WorldGravityZ", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("WorldGravityZ");
                Serialize<float>(std::static_pointer_cast<CPPRP::Engine::WorldInfo>(struc)->WorldGravityZ);
        });
RegisterJSONSerializer("Engine.WorldInfo:TimeDilation", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("TimeDilation");
                Serialize<float>(std::static_pointer_cast<CPPRP::Engine::WorldInfo>(struc)->TimeDilation);
        });
RegisterJSONSerializer("ProjectX.GRI_X:MatchGUID", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("MatchGUID");
                Serialize<std::string>(std::static_pointer_cast<CPPRP::ProjectX::GRI_X>(struc)->MatchGUID);
        });
RegisterJSONSerializer("ProjectX.GRI_X:ReplicatedGameMutatorIndex", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedGameMutatorIndex");
                Serialize<int>(std::static_pointer_cast<CPPRP::ProjectX::GRI_X>(struc)->ReplicatedGameMutatorIndex);
        });
RegisterJSONSerializer("ProjectX.GRI_X:bGameStarted", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bGameStarted");
                Serialize<bool>(std::static_pointer_cast<CPPRP::ProjectX::GRI_X>(struc)->bGameStarted);
        });
RegisterJSONSerializer("ProjectX.GRI_X:ReplicatedGamePlaylist", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedGamePlaylist");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::ProjectX::GRI_X>(struc)->ReplicatedGamePlaylist);
        });
RegisterJSONSerializer("ProjectX.GRI_X:GameServerID", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("GameServerID");
                Serialize<uint64_t>(std::static_pointer_cast<CPPRP::ProjectX::GRI_X>(struc)->GameServerID);
        });
RegisterJSONSerializer("ProjectX.GRI_X:Reservations", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("Reservations");
                Serialize<CPPRP::Reservation>(std::static_pointer_cast<CPPRP::ProjectX::GRI_X>(struc)->Reservations);
        });
RegisterJSONSerializer("TAGame.PRI_TA:MatchShots", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("MatchShots");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->MatchShots);
        });
RegisterJSONSerializer("TAGame.PRI_TA:PersistentCamera", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("PersistentCamera");
                Serialize<CPPRP::ActiveActor>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->PersistentCamera);
        });
RegisterJSONSerializer("TAGame.PRI_TA:SkillTier", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("SkillTier");
                Serialize<CPPRP::SkillTier>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->SkillTier);
        });
RegisterJSONSerializer("TAGame.PRI_TA:bUsingBehindView", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bUsingBehindView");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->bUsingBehindView);
        });
RegisterJSONSerializer("TAGame.PRI_TA:MatchAssists", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("MatchAssists");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->MatchAssists);
        });
RegisterJSONSerializer("TAGame.PRI_TA:RespawnTimeRemaining", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("RespawnTimeRemaining");
                Serialize<int>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->RespawnTimeRemaining);
        });
RegisterJSONSerializer("TAGame.PRI_TA:bOnlineLoadoutSet", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bOnlineLoadoutSet");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->bOnlineLoadoutSet);
        });
RegisterJSONSerializer("TAGame.PRI_TA:MatchGoals", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("MatchGoals");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->MatchGoals);
        });
RegisterJSONSerializer("TAGame.PRI_TA:ReplicatedGameEvent", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedGameEvent");
                Serialize<CPPRP::ActiveActor>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->ReplicatedGameEvent);
        });
RegisterJSONSerializer("TAGame.PRI_TA:TotalXP", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("TotalXP");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->TotalXP);
        });
RegisterJSONSerializer("TAGame.PRI_TA:MatchScore", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("MatchScore");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->MatchScore);
        });
RegisterJSONSerializer("TAGame.PRI_TA:MatchSaves", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("MatchSaves");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->MatchSaves);
        });
RegisterJSONSerializer("TAGame.PRI_TA:Title", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("Title");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->Title);
        });
RegisterJSONSerializer("TAGame.PRI_TA:ClubID", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ClubID");
                Serialize<uint64_t>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->ClubID);
        });
RegisterJSONSerializer("TAGame.PRI_TA:MaxTimeTillItem", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("MaxTimeTillItem");
                Serialize<int>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->MaxTimeTillItem);
        });
RegisterJSONSerializer("TAGame.PRI_TA:MatchBreakoutDamage", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("MatchBreakoutDamage");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->MatchBreakoutDamage);
        });
RegisterJSONSerializer("TAGame.PRI_TA:BotProductName", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("BotProductName");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->BotProductName);
        });
RegisterJSONSerializer("TAGame.PRI_TA:bReady", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bReady");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->bReady);
        });
RegisterJSONSerializer("TAGame.PRI_TA:SpectatorShortcut", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("SpectatorShortcut");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->SpectatorShortcut);
        });
RegisterJSONSerializer("TAGame.PRI_TA:bUsingSecondaryCamera", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bUsingSecondaryCamera");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->bUsingSecondaryCamera);
        });
RegisterJSONSerializer("TAGame.PRI_TA:PlayerHistoryValid", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("PlayerHistoryValid");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->PlayerHistoryValid);
        });
RegisterJSONSerializer("TAGame.PRI_TA:bIsInSplitScreen", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bIsInSplitScreen");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->bIsInSplitScreen);
        });
RegisterJSONSerializer("TAGame.PRI_TA:bMatchMVP", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bMatchMVP");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->bMatchMVP);
        });
RegisterJSONSerializer("TAGame.PRI_TA:RepStatTitles", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("RepStatTitles");
                Serialize<CPPRP::RepStatTitle>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->RepStatTitles);
        });
RegisterJSONSerializer("TAGame.PRI_TA:bOnlineLoadoutsSet", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bOnlineLoadoutsSet");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->bOnlineLoadoutsSet);
        });
RegisterJSONSerializer("TAGame.PRI_TA:bUsingItems", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bUsingItems");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->bUsingItems);
        });
RegisterJSONSerializer("TAGame.PRI_TA:PrimaryTitle", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("PrimaryTitle");
                Serialize<CPPRP::ReplicatedTitle>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->PrimaryTitle);
        });
RegisterJSONSerializer("TAGame.PRI_TA:bMatchAdmin", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bMatchAdmin");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->bMatchAdmin);
        });
RegisterJSONSerializer("TAGame.PRI_TA:bBusy", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bBusy");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->bBusy);
        });
RegisterJSONSerializer("TAGame.PRI_TA:bVoteToForfeitDisabled", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bVoteToForfeitDisabled");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->bVoteToForfeitDisabled);
        });
RegisterJSONSerializer("TAGame.PRI_TA:bUsingFreecam", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bUsingFreecam");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->bUsingFreecam);
        });
RegisterJSONSerializer("TAGame.PRI_TA:ClientLoadoutOnline", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ClientLoadoutOnline");
                Serialize<CPPRP::OnlineLoadout>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->ClientLoadoutOnline);
        });
RegisterJSONSerializer("TAGame.PRI_TA:CameraYaw", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("CameraYaw");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->CameraYaw);
        });
RegisterJSONSerializer("TAGame.PRI_TA:CameraPitch", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("CameraPitch");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->CameraPitch);
        });
RegisterJSONSerializer("TAGame.PRI_TA:PawnType", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("PawnType");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->PawnType);
        });
RegisterJSONSerializer("TAGame.PRI_TA:ReplicatedWorstNetQualityBeyondLatency", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedWorstNetQualityBeyondLatency");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->ReplicatedWorstNetQualityBeyondLatency);
        });
RegisterJSONSerializer("TAGame.PRI_TA:SteeringSensitivity", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("SteeringSensitivity");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->SteeringSensitivity);
        });
RegisterJSONSerializer("TAGame.PRI_TA:PartyLeader", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("PartyLeader");
                Serialize<CPPRP::PartyLeader>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->PartyLeader);
        });
RegisterJSONSerializer("TAGame.PRI_TA:TimeTillItem", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("TimeTillItem");
                Serialize<int>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->TimeTillItem);
        });
RegisterJSONSerializer("TAGame.PRI_TA:ClientLoadoutsOnline", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ClientLoadoutsOnline");
                Serialize<CPPRP::ClientLoadoutsOnline>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->ClientLoadoutsOnline);
        });
RegisterJSONSerializer("TAGame.PRI_TA:ClientLoadouts", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ClientLoadouts");
                Serialize<CPPRP::ClientLoadouts>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->ClientLoadouts);
        });
RegisterJSONSerializer("TAGame.PRI_TA:ClientLoadout", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ClientLoadout");
                Serialize<CPPRP::ClientLoadout>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->ClientLoadout);
        });
RegisterJSONSerializer("TAGame.PRI_TA:CameraSettings", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("CameraSettings");
                Serialize<CPPRP::CameraSettings>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->CameraSettings);
        });
RegisterJSONSerializer("TAGame.PRI_TA:SecondaryTitle", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("SecondaryTitle");
                Serialize<CPPRP::ReplicatedTitle>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->SecondaryTitle);
        });
RegisterJSONSerializer("TAGame.PRI_TA:PlayerHistoryKey", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("PlayerHistoryKey");
                Serialize<CPPRP::HistoryKey>(std::static_pointer_cast<CPPRP::TAGame::PRI_TA>(struc)->PlayerHistoryKey);
        });
RegisterJSONSerializer("TAGame.RBActor_TA:ReplicatedRBState", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedRBState");
                Serialize<CPPRP::ReplicatedRBState>(std::static_pointer_cast<CPPRP::TAGame::RBActor_TA>(struc)->ReplicatedRBState);
        });
RegisterJSONSerializer("TAGame.RBActor_TA:bReplayActor", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bReplayActor");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::RBActor_TA>(struc)->bReplayActor);
        });
RegisterJSONSerializer("TAGame.RBActor_TA:bFrozen", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bFrozen");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::RBActor_TA>(struc)->bFrozen);
        });
RegisterJSONSerializer("TAGame.RBActor_TA:WeldedInfo", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("WeldedInfo");
                Serialize<CPPRP::WeldedInfo>(std::static_pointer_cast<CPPRP::TAGame::RBActor_TA>(struc)->WeldedInfo);
        });
RegisterJSONSerializer("TAGame.RBActor_TA:bIgnoreSyncing", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bIgnoreSyncing");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::RBActor_TA>(struc)->bIgnoreSyncing);
        });
RegisterJSONSerializer("TAGame.CarComponent_TA:Vehicle", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("Vehicle");
                Serialize<CPPRP::ActiveActor>(std::static_pointer_cast<CPPRP::TAGame::CarComponent_TA>(struc)->Vehicle);
        });
RegisterJSONSerializer("TAGame.CarComponent_TA:ReplicatedActive", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedActive");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::CarComponent_TA>(struc)->ReplicatedActive);
        });
RegisterJSONSerializer("TAGame.CarComponent_TA:ReplicatedActivityTime", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedActivityTime");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::CarComponent_TA>(struc)->ReplicatedActivityTime);
        });
RegisterJSONSerializer("TAGame.CarComponent_Boost_TA:RechargeDelay", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("RechargeDelay");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::CarComponent_Boost_TA>(struc)->RechargeDelay);
        });
RegisterJSONSerializer("TAGame.CarComponent_Boost_TA:bUnlimitedBoost", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bUnlimitedBoost");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::CarComponent_Boost_TA>(struc)->bUnlimitedBoost);
        });
RegisterJSONSerializer("TAGame.CarComponent_Boost_TA:UnlimitedBoostRefCount", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("UnlimitedBoostRefCount");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::CarComponent_Boost_TA>(struc)->UnlimitedBoostRefCount);
        });
RegisterJSONSerializer("TAGame.CarComponent_Boost_TA:bNoBoost", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bNoBoost");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::CarComponent_Boost_TA>(struc)->bNoBoost);
        });
RegisterJSONSerializer("TAGame.CarComponent_Boost_TA:ReplicatedBoostAmount", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedBoostAmount");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::CarComponent_Boost_TA>(struc)->ReplicatedBoostAmount);
        });
RegisterJSONSerializer("TAGame.CarComponent_Boost_TA:RechargeRate", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("RechargeRate");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::CarComponent_Boost_TA>(struc)->RechargeRate);
        });
RegisterJSONSerializer("TAGame.CarComponent_Boost_TA:BoostModifier", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("BoostModifier");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::CarComponent_Boost_TA>(struc)->BoostModifier);
        });
RegisterJSONSerializer("TAGame.CarComponent_Dodge_TA:DodgeTorque", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("DodgeTorque");
                Serialize<CPPRP::Vector3I>(std::static_pointer_cast<CPPRP::TAGame::CarComponent_Dodge_TA>(struc)->DodgeTorque);
        });
RegisterJSONSerializer("TAGame.CarComponent_FlipCar_TA:bFlipRight", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bFlipRight");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::CarComponent_FlipCar_TA>(struc)->bFlipRight);
        });
RegisterJSONSerializer("TAGame.CarComponent_FlipCar_TA:FlipCarTime", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("FlipCarTime");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::CarComponent_FlipCar_TA>(struc)->FlipCarTime);
        });
RegisterJSONSerializer("TAGame.Ball_TA:GameEvent", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("GameEvent");
                Serialize<CPPRP::ActiveActor>(std::static_pointer_cast<CPPRP::TAGame::Ball_TA>(struc)->GameEvent);
        });
RegisterJSONSerializer("TAGame.Ball_TA:ReplicatedPhysMatOverride", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedPhysMatOverride");
                Serialize<CPPRP::ObjectTarget>(std::static_pointer_cast<CPPRP::TAGame::Ball_TA>(struc)->ReplicatedPhysMatOverride);
        });
RegisterJSONSerializer("TAGame.Ball_TA:ReplicatedBallGravityScale", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedBallGravityScale");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::Ball_TA>(struc)->ReplicatedBallGravityScale);
        });
RegisterJSONSerializer("TAGame.Ball_TA:ReplicatedBallScale", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedBallScale");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::Ball_TA>(struc)->ReplicatedBallScale);
        });
RegisterJSONSerializer("TAGame.Ball_TA:HitTeamNum", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("HitTeamNum");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::Ball_TA>(struc)->HitTeamNum);
        });
RegisterJSONSerializer("TAGame.Ball_TA:ReplicatedWorldBounceScale", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedWorldBounceScale");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::Ball_TA>(struc)->ReplicatedWorldBounceScale);
        });
RegisterJSONSerializer("TAGame.Ball_TA:ReplicatedAddedCarBounceScale", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedAddedCarBounceScale");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::Ball_TA>(struc)->ReplicatedAddedCarBounceScale);
        });
RegisterJSONSerializer("TAGame.Ball_TA:ReplicatedExplosionData", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedExplosionData");
                Serialize<CPPRP::ReplicatedExplosionData>(std::static_pointer_cast<CPPRP::TAGame::Ball_TA>(struc)->ReplicatedExplosionData);
        });
RegisterJSONSerializer("TAGame.Ball_TA:ReplicatedBallMaxLinearSpeedScale", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedBallMaxLinearSpeedScale");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::Ball_TA>(struc)->ReplicatedBallMaxLinearSpeedScale);
        });
RegisterJSONSerializer("TAGame.Ball_TA:ReplicatedExplosionDataExtended", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedExplosionDataExtended");
...
RegisterJSONSerializer("TAGame.Team_TA:LogoData", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("LogoData");
                Serialize<CPPRP::LogoData>(std::static_pointer_cast<CPPRP::TAGame::Team_TA>(struc)->LogoData);
        });
RegisterJSONSerializer("TAGame.Team_TA:GameEvent", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("GameEvent");
                Serialize<CPPRP::ActiveActor>(std::static_pointer_cast<CPPRP::TAGame::Team_TA>(struc)->GameEvent);
        });
RegisterJSONSerializer("TAGame.Team_TA:CustomTeamName", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("CustomTeamName");
                Serialize<std::string>(std::static_pointer_cast<CPPRP::TAGame::Team_TA>(struc)->CustomTeamName);
        });
RegisterJSONSerializer("TAGame.Team_TA:ClubID", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ClubID");
                Serialize<uint64_t>(std::static_pointer_cast<CPPRP::TAGame::Team_TA>(struc)->ClubID);
        });
RegisterJSONSerializer("TAGame.Team_TA:ClubColors", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ClubColors");
                Serialize<CPPRP::ClubColors>(std::static_pointer_cast<CPPRP::TAGame::Team_TA>(struc)->ClubColors);
        });
RegisterJSONSerializer("TAGame.Team_Soccar_TA:GameScore", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("GameScore");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::Team_Soccar_TA>(struc)->GameScore);
        });
RegisterJSONSerializer("TAGame.BreakOutActor_Platform_TA:DamageState", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("DamageState");
                Serialize<CPPRP::DamageState>(std::static_pointer_cast<CPPRP::TAGame::BreakOutActor_Platform_TA>(struc)->DamageState);
        });
RegisterJSONSerializer("TAGame.SpecialPickup_Targeted_TA:Targeted", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("Targeted");
                Serialize<CPPRP::ActiveActor>(std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_Targeted_TA>(struc)->Targeted);
        });
RegisterJSONSerializer("TAGame.SpecialPickup_BallVelcro_TA:bHit", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bHit");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_BallVelcro_TA>(struc)->bHit);
        });
RegisterJSONSerializer("TAGame.SpecialPickup_BallVelcro_TA:bBroken", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bBroken");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_BallVelcro_TA>(struc)->bBroken);
        });
RegisterJSONSerializer("TAGame.SpecialPickup_BallVelcro_TA:AttachTime", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("AttachTime");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_BallVelcro_TA>(struc)->AttachTime);
        });
RegisterJSONSerializer("TAGame.SpecialPickup_BallVelcro_TA:BreakTime", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("BreakTime");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_BallVelcro_TA>(struc)->BreakTime);
        });
RegisterJSONSerializer("TAGame.SpecialPickup_Rugby_TA:bBallWelded", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bBallWelded");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_Rugby_TA>(struc)->bBallWelded);
        });
RegisterJSONSerializer("TAGame.SpecialPickup_BallFreeze_TA:RepOrigSpeed", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("RepOrigSpeed");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::SpecialPickup_BallFreeze_TA>(struc)->RepOrigSpeed);
        });
RegisterJSONSerializer("TAGame.CrowdManager_TA:GameEvent", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("GameEvent");
                Serialize<CPPRP::ActiveActor>(std::static_pointer_cast<CPPRP::TAGame::CrowdManager_TA>(struc)->GameEvent);
        });
RegisterJSONSerializer("TAGame.CrowdManager_TA:ReplicatedGlobalOneShotSound", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedGlobalOneShotSound");
                Serialize<CPPRP::ObjectTarget>(std::static_pointer_cast<CPPRP::TAGame::CrowdManager_TA>(struc)->ReplicatedGlobalOneShotSound);
        });
RegisterJSONSerializer("TAGame.CrowdActor_TA:GameEvent", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("GameEvent");
                Serialize<CPPRP::ActiveActor>(std::static_pointer_cast<CPPRP::TAGame::CrowdActor_TA>(struc)->GameEvent);
        });
RegisterJSONSerializer("TAGame.CrowdActor_TA:ReplicatedOneShotSound", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedOneShotSound");
                Serialize<CPPRP::ObjectTarget>(std::static_pointer_cast<CPPRP::TAGame::CrowdActor_TA>(struc)->ReplicatedOneShotSound);
        });
RegisterJSONSerializer("TAGame.CrowdActor_TA:ReplicatedRoundCountDownNumber", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedRoundCountDownNumber");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::CrowdActor_TA>(struc)->ReplicatedRoundCountDownNumber);
        });
RegisterJSONSerializer("TAGame.CrowdActor_TA:ReplicatedCountDownNumber", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedCountDownNumber");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::CrowdActor_TA>(struc)->ReplicatedCountDownNumber);
        });
RegisterJSONSerializer("TAGame.CrowdActor_TA:ModifiedNoise", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ModifiedNoise");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::CrowdActor_TA>(struc)->ModifiedNoise);
        });
RegisterJSONSerializer("TAGame.Vehicle_TA:ReplicatedThrottle", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedThrottle");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::Vehicle_TA>(struc)->ReplicatedThrottle);
        });
RegisterJSONSerializer("TAGame.Vehicle_TA:bReplicatedHandbrake", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bReplicatedHandbrake");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::Vehicle_TA>(struc)->bReplicatedHandbrake);
        });
RegisterJSONSerializer("TAGame.Vehicle_TA:bDriving", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bDriving");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::Vehicle_TA>(struc)->bDriving);
        });
RegisterJSONSerializer("TAGame.Vehicle_TA:ReplicatedSteer", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedSteer");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::Vehicle_TA>(struc)->ReplicatedSteer);
        });
RegisterJSONSerializer("TAGame.Car_TA:AttachedPickup", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("AttachedPickup");
                Serialize<CPPRP::ActiveActor>(std::static_pointer_cast<CPPRP::TAGame::Car_TA>(struc)->AttachedPickup);
        });
RegisterJSONSerializer("TAGame.Car_TA:AddedCarForceMultiplier", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("AddedCarForceMultiplier");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::Car_TA>(struc)->AddedCarForceMultiplier);
        });
RegisterJSONSerializer("TAGame.Car_TA:ReplicatedCarScale", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedCarScale");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::Car_TA>(struc)->ReplicatedCarScale);
        });
RegisterJSONSerializer("TAGame.Car_TA:AddedBallForceMultiplier", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("AddedBallForceMultiplier");
                Serialize<float>(std::static_pointer_cast<CPPRP::TAGame::Car_TA>(struc)->AddedBallForceMultiplier);
        });
RegisterJSONSerializer("TAGame.Car_TA:TeamPaint", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("TeamPaint");
                Serialize<CPPRP::TeamPaint>(std::static_pointer_cast<CPPRP::TAGame::Car_TA>(struc)->TeamPaint);
        });
RegisterJSONSerializer("TAGame.Car_TA:ReplicatedDemolish", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedDemolish");
                Serialize<CPPRP::ReplicatedDemolish>(std::static_pointer_cast<CPPRP::TAGame::Car_TA>(struc)->ReplicatedDemolish);
        });
RegisterJSONSerializer("TAGame.Car_TA:ClubColors", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ClubColors");
                Serialize<CPPRP::ClubColors>(std::static_pointer_cast<CPPRP::TAGame::Car_TA>(struc)->ClubColors);
        });
RegisterJSONSerializer("TAGame.CameraSettingsActor_TA:PRI", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("PRI");
                Serialize<CPPRP::ActiveActor>(std::static_pointer_cast<CPPRP::TAGame::CameraSettingsActor_TA>(struc)->PRI);
        });
RegisterJSONSerializer("TAGame.CameraSettingsActor_TA:CameraPitch", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("CameraPitch");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::CameraSettingsActor_TA>(struc)->CameraPitch);
        });
RegisterJSONSerializer("TAGame.CameraSettingsActor_TA:bMouseCameraToggleEnabled", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bMouseCameraToggleEnabled");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::CameraSettingsActor_TA>(struc)->bMouseCameraToggleEnabled);
        });
RegisterJSONSerializer("TAGame.CameraSettingsActor_TA:bUsingSecondaryCamera", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bUsingSecondaryCamera");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::CameraSettingsActor_TA>(struc)->bUsingSecondaryCamera);
        });
RegisterJSONSerializer("TAGame.CameraSettingsActor_TA:bUsingBehindView", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bUsingBehindView");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::CameraSettingsActor_TA>(struc)->bUsingBehindView);
        });
RegisterJSONSerializer("TAGame.CameraSettingsActor_TA:ProfileSettings", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ProfileSettings");
                Serialize<CPPRP::CameraSettings>(std::static_pointer_cast<CPPRP::TAGame::CameraSettingsActor_TA>(struc)->ProfileSettings);
        });
RegisterJSONSerializer("TAGame.CameraSettingsActor_TA:bUsingSwivel", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bUsingSwivel");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::CameraSettingsActor_TA>(struc)->bUsingSwivel);
        });
RegisterJSONSerializer("TAGame.CameraSettingsActor_TA:CameraYaw", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("CameraYaw");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::CameraSettingsActor_TA>(struc)->CameraYaw);
        });
RegisterJSONSerializer("TAGame.GRI_TA:NewDedicatedServerIP", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("NewDedicatedServerIP");
                Serialize<std::string>(std::static_pointer_cast<CPPRP::TAGame::GRI_TA>(struc)->NewDedicatedServerIP);
        });
RegisterJSONSerializer("TAGame.Ball_Breakout_TA:DamageIndex", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("DamageIndex");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::Ball_Breakout_TA>(struc)->DamageIndex);
        });
RegisterJSONSerializer("TAGame.Ball_Breakout_TA:AppliedDamage", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("AppliedDamage");
                Serialize<CPPRP::AppliedDamage>(std::static_pointer_cast<CPPRP::TAGame::Ball_Breakout_TA>(struc)->AppliedDamage);
        });
RegisterJSONSerializer("TAGame.Ball_Breakout_TA:LastTeamTouch", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("LastTeamTouch");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::Ball_Breakout_TA>(struc)->LastTeamTouch);
        });
RegisterJSONSerializer("TAGame.VehiclePickup_TA:bNoPickup", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bNoPickup");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::VehiclePickup_TA>(struc)->bNoPickup);
        });
RegisterJSONSerializer("TAGame.VehiclePickup_TA:ReplicatedPickupData", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedPickupData");
                Serialize<CPPRP::ReplicatedPickupData>(std::static_pointer_cast<CPPRP::TAGame::VehiclePickup_TA>(struc)->ReplicatedPickupData);
        });
RegisterJSONSerializer("TAGame.Ball_Haunted_TA:DeactivatedGoalIndex", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("DeactivatedGoalIndex");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::Ball_Haunted_TA>(struc)->DeactivatedGoalIndex);
        });
RegisterJSONSerializer("TAGame.Ball_Haunted_TA:bIsBallBeamed", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bIsBallBeamed");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::Ball_Haunted_TA>(struc)->bIsBallBeamed);
        });
RegisterJSONSerializer("TAGame.Ball_Haunted_TA:ReplicatedBeamBrokenValue", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedBeamBrokenValue");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::Ball_Haunted_TA>(struc)->ReplicatedBeamBrokenValue);
        });
RegisterJSONSerializer("TAGame.Ball_Haunted_TA:LastTeamTouch", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("LastTeamTouch");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::Ball_Haunted_TA>(struc)->LastTeamTouch);
        });
RegisterJSONSerializer("TAGame.Ball_Haunted_TA:TotalActiveBeams", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("TotalActiveBeams");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::Ball_Haunted_TA>(struc)->TotalActiveBeams);
        });
RegisterJSONSerializer("TAGame.GameEvent_TA:ReplicatedRoundCountDownNumber", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedRoundCountDownNumber");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_TA>(struc)->ReplicatedRoundCountDownNumber);
        });
RegisterJSONSerializer("TAGame.GameEvent_TA:ActivatorCar", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ActivatorCar");
                Serialize<CPPRP::ActiveActor>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_TA>(struc)->ActivatorCar);
        });
RegisterJSONSerializer("TAGame.GameEvent_TA:ReplicatedGameStateTimeRemaining", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedGameStateTimeRemaining");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_TA>(struc)->ReplicatedGameStateTimeRemaining);
        });
RegisterJSONSerializer("TAGame.GameEvent_TA:ReplicatedStateName", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedStateName");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_TA>(struc)->ReplicatedStateName);
        });
RegisterJSONSerializer("TAGame.GameEvent_TA:MatchTypeClass", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("MatchTypeClass");
                Serialize<CPPRP::ObjectTarget>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_TA>(struc)->MatchTypeClass);
        });
RegisterJSONSerializer("TAGame.GameEvent_TA:BotSkill", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("BotSkill");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_TA>(struc)->BotSkill);
        });
RegisterJSONSerializer("TAGame.GameEvent_TA:bHasLeaveMatchPenalty", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bHasLeaveMatchPenalty");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_TA>(struc)->bHasLeaveMatchPenalty);
        });
RegisterJSONSerializer("TAGame.GameEvent_TA:bCanVoteToForfeit", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bCanVoteToForfeit");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_TA>(struc)->bCanVoteToForfeit);
        });
RegisterJSONSerializer("TAGame.GameEvent_TA:bAllowReadyUp", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bAllowReadyUp");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_TA>(struc)->bAllowReadyUp);
        });
RegisterJSONSerializer("TAGame.GameEvent_TA:GameMode", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("GameMode");
                Serialize<CPPRP::GameMode>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_TA>(struc)->GameMode);
        });
RegisterJSONSerializer("TAGame.GameEvent_TA:ReplicatedStateIndex", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedStateIndex");
                Serialize<CPPRP::ReplicatedStateIndex>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_TA>(struc)->ReplicatedStateIndex);
        });
RegisterJSONSerializer("TAGame.GameEvent_Team_TA:MaxTeamSize", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("MaxTeamSize");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Team_TA>(struc)->MaxTeamSize);
        });
RegisterJSONSerializer("TAGame.GameEvent_Team_TA:bForfeit", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bForfeit");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Team_TA>(struc)->bForfeit);
        });
RegisterJSONSerializer("TAGame.GameEvent_Team_TA:bDisableMutingOtherTeam", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bDisableMutingOtherTeam");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Team_TA>(struc)->bDisableMutingOtherTeam);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:bOverTime", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bOverTime");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->bOverTime);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:GameTime", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("GameTime");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->GameTime);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:MVP", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("MVP");
                Serialize<CPPRP::ActiveActor>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->MVP);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:MatchWinner", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("MatchWinner");
                Serialize<CPPRP::ActiveActor>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->MatchWinner);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:GameWinner", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("GameWinner");
                Serialize<CPPRP::ActiveActor>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->GameWinner);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:SubRulesArchetype", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("SubRulesArchetype");
                Serialize<CPPRP::ObjectTarget>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->SubRulesArchetype);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:SecondsRemaining", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("SecondsRemaining");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->SecondsRemaining);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:RoundNum", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("RoundNum");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->RoundNum);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:SeriesLength", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("SeriesLength");
                Serialize<uint32_t>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->SeriesLength);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:ReplicatedMusicStinger", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedMusicStinger");
...
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:bBallHasBeenHit", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bBallHasBeenHit");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->bBallHasBeenHit);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:bUnlimitedTime", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bUnlimitedTime");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->bUnlimitedTime);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:ReplicatedStatEvent", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedStatEvent");
                Serialize<CPPRP::ReplicatedStatEvent>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->ReplicatedStatEvent);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:bShowIntroScene", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bShowIntroScene");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->bShowIntroScene);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:bClubMatch", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bClubMatch");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->bClubMatch);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:ReplicatedScoredOnTeam", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedScoredOnTeam");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->ReplicatedScoredOnTeam);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:bMatchEnded", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("bMatchEnded");
                Serialize<bool>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->bMatchEnded);
        });
RegisterJSONSerializer("TAGame.GameEvent_Soccar_TA:ReplicatedServerPerformanceState", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("ReplicatedServerPerformanceState");
                Serialize<unsigned char>(std::static_pointer_cast<CPPRP::TAGame::GameEvent_Soccar_TA>(struc)->ReplicatedServerPerformanceState);
        });
RegisterJSONSerializer("TAGame.GameEvent_SoccarPrivate_TA:MatchSettings", [](Writer& writer, std::shared_ptr<CPPRP::Engine::Actor>& struc) {
                writer.String("MatchSettings");
